...
/**
 * Determines CEFR level based on total score.
 */
...
/**
 * Returns a general performance description based on percentage.
 */
...
/**
 * Returns section-specific feedback based on score and section type.
 */
export const getSectionFeedback = (
  sectionId: string,
  score: number,
  maxScore: number
): string => {
  ...
  const feedbackMap: Record<string, Record<'high' | 'medium' | 'low', string>> = {
    vocabulary: {
    ...
    grammar: {
      ...
      low: 'Basic grammar knowledge – focus on sentence structure and verb usage.'
    },
    reading: {
      high: 'Excellent reading comprehension with strong analytical and inference skills.',
      medium: 'Good reading skills with solid understanding of main ideas and supporting details.',
    ...
    writing: {
      ...
      low: 'Basic writing ability – focus on clarity, structure, and tone.'
    },
    speaking: {
